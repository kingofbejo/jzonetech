                                    ...
                                    <li class="item">
                                        ...
                                        <div class="product-info">
                                            <a href="javascript:void(0)" class="product-title"><?php echo $devent->nama_event; ?>
                                                <span class="badge badge-success"><?php echo $devent->fee; ?></span></a> <button type="button" class="btn btn-primary btn-sm float-right" data-toggle="modal" data-target="#exampleModal"><span class="cil-contrast btn-icon fa fa-plus-circle "></span> input</button>

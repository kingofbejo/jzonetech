                                        ...
                                        <div class="card-body box-profile">
                                            ...
                                            <ul class="list-group list-group-unbordered mb-3">
                                                <li class="list-group-item">
                                                    <b>Total Orders</b> <a class="float-right">1,322</a>
                                                </li>
                                                <li class="list-group-item">
                                                    <b>Total Pendapatan</b> <a class="float-right">543</a>
                                                </li>


                                                <li class="list-group-item">
                                                    <strong><i class="fa fa-university mr-1"></i> Bank</strong>
                                                ...
                                                <li class="list-group-item">
                                                    <strong><i class="fa fa-university mr-1"></i> Nomor Rekening</strong>

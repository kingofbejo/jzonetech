                                ...
                                <table class="table m-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="sparkbar" data-color="#00a65a" data-height="20"><?= $user['name']; ?></div>
                                            </td>
                                            <td>
                                                <ul class="list-inline m-0">
                                                    <li class="list-inline-item">
                                                        <button class="btn btn-primary btn-sm " type="button" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i><span><strong> Edit</strong></span> </button>
                                                    </li>

                                                    <li class="list-inline-item">
                                                        <button class="btn btn-danger btn-sm " data-toggle="modal" data-target="#exampleModal" type="button" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash"></i><span><strong> Delete</strong></span></button>
                                                    </li>
                                                </ul>
